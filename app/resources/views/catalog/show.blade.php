    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12" id="product-detail-container">
        ...
        <div class="flex flex-col justify-start">
            ...
            <div class="mt-8 space-y-3">
                @if($product->status === 'active')
                    {{-- Botón WhatsApp (Checkout Visual) --}}
                    <button type="button" class="sc-btn sc-btn-whatsapp sc-btn-lg w-full justify-center" id="whatsapp-order-btn">
                    ...
                    <button type="button" class="sc-btn sc-btn-secondary w-full justify-center" id="add-to-cart-detail-btn" data-product-id="{{ $product->id }}">
                        Agregar al Carrito
                    </button>
                @else
